-- CreateEnum
CREATE TYPE "public"."ProductionType" AS ENUM ('SOB_ENCOMENDA', 'EM_ESTOQUE');
...
CREATE TABLE "public"."products" (
    ...
    "productionType" "public"."ProductionType" NOT NULL DEFAULT 'SOB_ENCOMENDA',
    "stock" INTEGER,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
